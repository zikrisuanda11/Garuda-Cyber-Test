      ...
      <div className="flex gap-20  justify-center">
        ...
        <form onSubmit={handleSubmit} className="border shadow-xl flex flex-col gap-5 p-10 rounded-md w-96">
          <div className="text-center flex gap-2 flex-col">
            <h1 className="text-2xl font-bold font-sans">Login Sekarang</h1>
            <p className="font-sans text-sm text-gray-500">Belum punya akun Tokopedia? <a className="text-primary" href="/register">Daftar</a></p>
          </div>
